        ...
        >
          ...
          >
            ...
            >
              ...
              <Menu.Item key="invoices-receipts">
                <Link to={`${url}/invoices-receipts`}>
                  <span className="isoMenuHolder">
                    <i className="ion-grid" />
                    <span className="nav-text">Invoices & Receipts</span>
                  </span>
                </Link>
              </Menu.Item>

              <Menu.Item key="bank-&-card-statements">
                <Link to={`${url}/bank-&-card-statements`}>
                  <span className="isoMenuHolder">
                    <i className="ion-grid" />
                    <span className="nav-text">Bank & Card Statements</span>
                  </span>
                </Link>
              </Menu.Item>

              <Menu.Item key="all-documents">
                <Link to={`${url}/all-documents`}>
                  <span className="isoMenuHolder">
                    <i className="ion-grid" />
              ...
              <Menu.Item key="recyle-bin">
                <Link to={`${url}/recyle-bin`}>
                  <span className="isoMenuHolder">
                    <i className="ion-grid" />
                    <span className="nav-text">Recyle Bin</span>
                  </span>
                </Link>
              </Menu.Item>
              ...
              <SubMenu
                title={
                  <span className="isoMenuHolder" style={submenuColor}>
                    <i className="ion-grid" />
                    <span className="nav-text">Integration Data</span>
                  </span>
                }
              >
                <Menu.Item style={submenuStyle} >
